"""
Clarity CX — Observability Module
...
class ClarityObserver:
    ...
    def span(self, trace: TraceRecord, name: str, metadata: dict | None = None):
        ...
        Usage:
            with observer.span(trace, "summarization_agent") as span:
...
_observer: ClarityObserver | None = None


def get_observer() -> ClarityObserver:
    """Get or create the global observer instance."""
    global _observer
    if _observer is None:
        _observer = ClarityObserver()
    return _observer
